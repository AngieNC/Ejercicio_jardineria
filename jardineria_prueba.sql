DROP DATABASE IF EXISTS jardineria_ejercicio;
CREATE DATABASE jardineria_ejercicio;
USE jardineria_ejercicio;

/*CONSTRAINT*/
-----SOLO prueba, no es necesario 
...
CREATE TABLE oficina (
  ...
  CONSTRAINT pk_codigo_oficina_id PRIMARY KEY (codigo_oficina)
);
...
CREATE TABLE empleado (
  ...
  CONSTRAINT pk_codigo_empleado_id PRIMARY KEY (codigo_empleado),
  CONSTRAINT fk_codigo_oficina_codigo_oficina FOREIGN KEY (codigo_oficina) REFERENCES oficina (codigo_oficina),
  CONSTRAINT fk_codigo_oficina_codigo_oficina FOREIGN KEY (codigo_jefe) REFERENCES empleado (codigo_empleado)
);
